  ...
  render(){
    return(
      ...
      <Card>
          ...
          {/* <button onClick={this.clickHandler2} type="button" className="btn btn-info" style={{marginInline: '10px'}}>Review</button> */}
        ...
        {/* {this.state.clicked2 ? (<AddToPlaylistForm playlist={this.props.playlist} track={this.props.track} addToPlaylist={this.props.addToPlaylist}/>) : (null)} */}
